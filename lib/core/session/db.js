        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                        _context2.next = 5;
                        return this.ctx.knex(this.options.table).where(this.key, this.options.cookie).first();
                    ...
                    case 5:
                        ...
                        // 创建数据
                        _context2.next = 13;
                        return this.ctx.knex(this.options.table).insert(val);
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            _context6.next = 5;
                            return this.ctx.knex(this.options.table).where(this.key, this.options.cookie).update(val);
