const getConfigFn = require('./core/config').getConfigFn;
...
const jinghuanLoader = class {
    ...
    loadAll(type, isCli) {
        ...
        jinghuan.config = getConfigFn(config, jinghuan.loader.modules.length > 0);
