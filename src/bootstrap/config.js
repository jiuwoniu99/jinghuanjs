...
export default {
    ...
    onUnhandledRejection: err => jinghuan.logger.error(err), // unhandledRejection handle
    onUncaughtException: err => jinghuan.logger.error(err), // uncaughtException handle
